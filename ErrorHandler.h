...
typedef enum { NO_ERROR = 0, MANY_ARGS, FEW_ARGS, ARG_NOT_YEAR, ARG_OUTOF_RANGE, CANT_OPEN_MOV, CANT_OPEN_AIRP, MULTIPLE_ELEMS_OACI, CANT_CREATE_FILE_Q1, CANT_CREATE_FILE_Q3 } TErrors;
