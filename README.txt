...
Contenidos de la carpeta PI_TPE:
	- README.txt
	- main.c
	- ErrorHandler.c
	- ErrorHandler.h
...
--- Como compilar:
	...
	Tener en cuenta que OUTPUT_NAME es el nombre con que va a salir el ejecutable del programa, cámbielo a gusto(Cumpliendo las normas para nombrar archivos).
...
--- Algunas consideraciones para las estadísticas de los Query:
	...
	- Para el Query 4, los vuelos cuyo código OACI era del estilo "N/A" o "AR-####" o "SA##" o no era un código OACI común, ejemplo "FAA EJERCITO ARGENTINO", fueron todos agrupados en los movimientos con aeropuertos desconocidos. Estos se expresan de la forma:
		CODIGO_OACI;;#;#
